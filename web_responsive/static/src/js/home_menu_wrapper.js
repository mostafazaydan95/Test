odoo.define("web_responsive.HomeMenuWrapper", function (require) {
    "use strict";

    const HomeMenu = require('web_responsive.HomeMenu');
            ...
            utils.traversePath(menuData, (menuItem, parents) => {
                ...
                if (!menuItem.parent_id) {
                    if (menuItem.web_icon_data) {
                        ...
                        item.webIconData = '/web_responsive/static/src/img/default_icon_app.png';
                    }
                } else {
