odoo.define("web_responsive.expiration_panel_tests", function (require) {
    "use strict";

    const ExpirationPanel = require("web_responsive.ExpirationPanel");
    ...
    QUnit.module("web_responsive", {}, function () {
