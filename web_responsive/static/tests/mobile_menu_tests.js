odoo.define('web_responsive.mobile_menu_tests', function (require) {
"use strict";

var Menu = require('web_responsive.Menu');
var testUtils = require('web.test_utils');
var testUtilsEnterprise = require('web_responsive.test_utils');
var UserMenu = require('web.UserMenu');

QUnit.module('web_responsive mobile_menu_tests', {
    afterEach() {
